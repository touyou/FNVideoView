#
#  Be sure to run `pod spec lint FNVideoView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "nakazawa fumito"
  # s.authors            = { "nakazawa fumito" => "email@address.com" }
  ...
  s.source       = { :git => "https://github.com/funzin/FNVideoView.git", :tag => "#{s.version}" }
